...
// current airline id from session (standardized)
...
<body>
    <div class="d-flex flex-column vh-100 w-100 overflow-hidden">
            ...
            <aside class="bg-light border-end ps-2" style="width: 280px; flex-shrink: 0;">
                <div class="card shadow-sm mx-2 my-3">
                    <div class="card-body p-3">
                        ...
                        renderFilterSidebar('/airline/flight-schedules', [
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($row['airline_id'] == $currentAirlineId): ?>
                                                        ...
                                                        <form action="/airline/flight-schedules/delete?id=<?= $row['id'] ?>"
                                                        ...
                                                        $action = "/airline/flight-schedules/update";
        ...
        <?php if ($currentAirlineId): ?>
            ...
            $action = "/airline/flight-schedules/store";
            $fields = $scheduleFields;
            $values = [];

...
<body>
    <div class="d-flex flex-column vh-100 w-100 overflow-hidden">
            ...
            <aside class="bg-light border-end ps-2" style="width: 280px; flex-shrink: 0;">
                <div class="card shadow-sm mx-2 my-3">
                    <div class="card-body p-3">
                        ...
                        renderFilterSidebar('/admin/flight-routes', [
                            ['name' => 'id', 'label' => 'Route ID', 'placeholder' => 'Enter route ID'],
                            ['name' => 'aid', 'label' => 'Airline', 'placeholder' => 'Select airline'],
                                        ...
                                        <?php foreach ($routes as $row): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="/admin/flight-routes/delete?id=<?= $row['id'] ?>" method="post" class="d-inline">
                                            ...
                                            $action = "/admin/flight-routes/update";
                                            $fields = $routeFields;
                                            $values = [
                                                'id' => $row['id'],
                                                'aid' => $row['aid'],
        ...
        $action = "/admin/flight-routes/store";
        $fields = $routeFields;
